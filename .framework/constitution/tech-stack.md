...
- Azure variant (implemented with partial sanitized HTTP evidence): AzureRM/AzAPI Terraform, Python 3.11 Azure Functions Flex Consumption, Service Bus queues with native DLQ, Cosmos DB Change Feed, managed identities, scoped RBAC, Application Insights, and Log Analytics.
...
- Provider variants must use documented cost guardrails and teardown boundaries; free-tier availability and regional capacity remain external prerequisites.
